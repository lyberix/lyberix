                                                                            ...
                                                                            spinnerFrame(0)
{
    ...
    QString windowTitle = tr("LYBERIXV3-Coin") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions(const NetworkStyle* networkStyle)
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a LYBERIXV3 address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and lyberixv3: URIs)"));
    ...
    aboutAction = new QAction(networkStyle->getAppIcon(), tr("&About LYBERIXV3 Core"), this);
    aboutAction->setStatusTip(tr("Show information about LYBERIXV3 Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for LYBERIXV3"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your LYBERIXV3 addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified LYBERIXV3 addresses"));
    ...
    openAction->setStatusTip(tr("Open a LYBERIXV3: URI or payment request"));
    openBlockExplorerAction = new QAction(QIcon(":/icons/explorer"), tr("&Blockchain explorer"), this);
    openBlockExplorerAction->setStatusTip(tr("Block explorer window"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the LYBERIXV3 Core help message to get a list with possible LYBERIXV3 command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle* networkStyle)
{
    ...
    QString toolTip = tr("LYBERIXV3 Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to LYBERIXV3 network", "", count));
}
...
{
    QString strTitle = tr("LYBERIXV3 Core"); // default title
