...
RESOURCES += src/qt/lyberix.qrc src/qt/lyberix_locale.qrc

TRANSLATIONS += src/qt/locale/lyberix_bg.ts \
                src/qt/locale/lyberix_de.ts \
                src/qt/locale/lyberix_en.ts \
                src/qt/locale/lyberix_es.ts \
                src/qt/locale/lyberix_fi.ts \
                src/qt/locale/lyberix_fr.ts \
                src/qt/locale/lyberix_it.ts \
                src/qt/locale/lyberix_ja.ts \
                src/qt/locale/lyberix_pl.ts \
                src/qt/locale/lyberix_pt.ts \
                src/qt/locale/lyberix_ru.ts \
                src/qt/locale/lyberix_sk.ts \
                src/qt/locale/lyberix_sv.ts \
                src/qt/locale/lyberix_vi.ts \
                src/qt/locale/lyberix_zh_CN.ts \
                src/qt/locale/lyberix_zh_TW.ts
