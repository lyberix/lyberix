...
/** 
    ...
    ****Note - for LYBERIXV3 we added fCoinStake to the 2nd bit. Keep in mind when reading the following and adjust as needed.
...
public:
    ...
    /** 
     * Amount of lyberixv3 coming in to a transaction
