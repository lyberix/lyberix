...
static bool AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || mapArgs.count("-?") || mapArgs.count("-help")) {
        ...
        std::string strUsage = _("LYBERIX Core lyberix-tx utility version") + " " + FormatFullVersion() + "\n\n" +
                               _("Usage:") + "\n" +
                               "  lyberix-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded lyberix transaction") + "\n" +
                               "  lyberix-tx [options] -create [commands]   " + _("Create hex-encoded lyberix transaction") + "\n" +
                               "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded lyberix transaction
