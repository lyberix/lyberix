...
/** Utility functions used by the LYBERIX Qt UI.
 */
namespace GUIUtil
{
...
// Render LYBERIX addresses in monospace font
...
// Parse "lyberix:" URI into recipient object, return true on successful parsing
