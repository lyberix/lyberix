                                                                            ...
                                                                            spinnerFrame(0)
{
    ...
    QString windowTitle = tr("LYBERIX-Coin") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions(const NetworkStyle* networkStyle)
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a LYBERIX address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and lyberix: URIs)"));
    ...
    aboutAction = new QAction(networkStyle->getAppIcon(), tr("&About LYBERIX Core"), this);
    aboutAction->setStatusTip(tr("Show information about LYBERIX Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for LYBERIX"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your LYBERIX addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified LYBERIX addresses"));
    ...
    openAction->setStatusTip(tr("Open a LYBERIX: URI or payment request"));
    openBlockExplorerAction = new QAction(QIcon(":/icons/explorer"), tr("&Blockchain explorer"), this);
    openBlockExplorerAction->setStatusTip(tr("Block explorer window"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the LYBERIX Core help message to get a list with possible LYBERIX command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle* networkStyle)
{
    ...
    QString toolTip = tr("LYBERIX Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to LYBERIX network", "", count));
}
...
{
    QString strTitle = tr("LYBERIX Core"); // default title
