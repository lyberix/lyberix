...
{
    const char* pszTimestamp = "Last good day to evacuate";
...
static Checkpoints::MapCheckpoints mapCheckpoints =
    boost::assign::map_list_of
		(0, uint256("0x00000b16b836be14926188443f448de2fe2323335bed4e5a932d9ed60582ab63"))
		;
...
public:
    CMainParams()
    {
        ...
        genesis = CreateGenesisBlock(1536815227, 21347990, 0x1e0ffff0, 1, 0 * COIN);

        hashGenesisBlock = genesis.GetHash();

        assert(hashGenesisBlock == uint256("0x00000b16b836be14926188443f448de2fe2323335bed4e5a932d9ed60582ab63"));
        assert(genesis.hashMerkleRoot == uint256("0xea2ec51c10daad8cbcb7bf70e923d057007687c08b2cb4bc2759d26bd558c886"));
		
	vSeeds.push_back(CDNSSeedData("s1.lyberix.com", "s1.lyberix.com"));
	vSeeds.push_back(CDNSSeedData("s2.lyberix.com", "s2.lyberix.com"));
	vSeeds.push_back(CDNSSeedData("s3.lyberix.com", "s3.lyberix.com"));
	...
	nStartMasternodePayments = 1536815227; 
