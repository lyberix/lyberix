...
Value getinfo(const Array& params, bool fHelp)
{
    if (fHelp || params.size() != 0)
        throw runtime_error(
            ...
            "  \"paytxfee\": x.xxxx,         (numeric) the transaction fee set in lyberixv3/kb\n"
            "  \"relayfee\": x.xxxx,         (numeric) minimum relay fee for non-free transactions in lyberixv3/kb\n"
...
Value validateaddress(const Array& params, bool fHelp)
{
    if (fHelp || params.size() != 1)
        throw runtime_error(
            "validateaddress \"lyberixv3address\"\n"
            "\nReturn information about the given lyberixv3 address.\n"
            "\nArguments:\n"
            "1. \"lyberixv3address\"     (string, required) The lyberixv3 address to validate\n"
            "\nResult:\n"
            "{\n"
            "  \"isvalid\" : true|false,         (boolean) If the address is valid or not. If not, this is the only property returned.\n"
            "  \"address\" : \"lyberixv3address\", (string) The lyberixv3 address validated\n"
...
#ifdef ENABLE_WALLET
        // Case 1: LYBERIXV3 address and we have full public key:
...
Value createmultisig(const Array& params, bool fHelp)
{
    if (fHelp || params.size() < 2 || params.size() > 2) {
        string msg = "createmultisig nrequired [\"key\",...]\n"
                     ...
                     "2. \"keys\"       (string, required) A json array of keys which are lyberixv3 addresses or hex-encoded public keys\n"
                     "     [\n"
                     "       \"key\"    (string) lyberixv3 address or hex-encoded public key\n"
                     "       ,...\n"
                     "     ]\n"
...
Value verifymessage(const Array& params, bool fHelp)
{
    if (fHelp || params.size() != 3)
        throw runtime_error(
            "verifymessage \"lyberixv3address\" \"signature\" \"message\"\n"
            "\nVerify a signed message\n"
            "\nArguments:\n"
            "1. \"lyberixv3address\"  (string, required) The lyberixv3 address to use for the signature.\n"
