...
In order to support loading of multiple wallets in lyberixv3-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is lyberixv3.cpp.
...
Changes to lyberixv3.cpp
----------------------
lyberixv3.cpp is the entry point into lyberixv3-qt, and as such, will require some minor modifications to provide hooks for
