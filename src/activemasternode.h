...
private:
    ...
    /// Get 10000 LYBERIXV3 input that can be used for the Masternode
...
{
public:
    /// Is the inputs associated with this public key? (and there is 10000 LYBERIXV3 - checking if valid masternode)
