...
void Intro::pickDataDirectory()
{
    ...
    if (!fs::exists(GUIUtil::qstringToBoostPath(dataDir)) || GetBoolArg("-choosedatadir", false)) {
        ...
        while (true) {
            ...
            try {
                ...
                QMessageBox::critical(0, tr("LYBERIXV3 Core"),
     ...
     * override -datadir in the lyberixv3.conf file in the default data directory
     * (to be consistent with lyberixv3d behavior)
     */
    if (dataDir != getDefaultDataDirectory())
