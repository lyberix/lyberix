...
/** Utility functions used by the LYBERIXV3 Qt UI.
 */
namespace GUIUtil
{
...
// Render LYBERIXV3 addresses in monospace font
...
// Parse "lyberixv3:" URI into recipient object, return true on successful parsing
