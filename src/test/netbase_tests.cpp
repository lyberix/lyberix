...
// Copyright (c) 2014-2015 The Etter and DASH Core Developers
...
BOOST_AUTO_TEST_CASE(netbase_splithost)
{
    ...
    BOOST_CHECK(TestSplitHost("127.0.0.1:40014", "127.0.0.1", 40014));
    BOOST_CHECK(TestSplitHost("[127.0.0.1]", "127.0.0.1", -1));
    BOOST_CHECK(TestSplitHost("[127.0.0.1]:40014", "127.0.0.1", 40014));
    BOOST_CHECK(TestSplitHost("::ffff:127.0.0.1", "::ffff:127.0.0.1", -1));
    BOOST_CHECK(TestSplitHost("[::ffff:127.0.0.1]:40014", "::ffff:127.0.0.1", 40014));
    BOOST_CHECK(TestSplitHost("[::]:40014", "::", 40014));
    BOOST_CHECK(TestSplitHost("::40014", "::40014", -1));
    BOOST_CHECK(TestSplitHost(":40014", "", 40014));
    BOOST_CHECK(TestSplitHost("[]:40014", "", 40014));
...
BOOST_AUTO_TEST_CASE(netbase_lookupnumeric)
{
    ...
    BOOST_CHECK(TestParse("127.0.0.1:40014", "127.0.0.1:40014"));
    BOOST_CHECK(TestParse("::ffff:127.0.0.1", "127.0.0.1:65535"));
    BOOST_CHECK(TestParse("::", "[::]:65535"));
    BOOST_CHECK(TestParse("[::]:40014", "[::]:40014"));
    BOOST_CHECK(TestParse("[127.0.0.1]", "127.0.0.1:65535"));
