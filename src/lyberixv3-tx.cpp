...
static bool AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || mapArgs.count("-?") || mapArgs.count("-help")) {
        ...
        std::string strUsage = _("LYBERIXV3 Core lyberixv3-tx utility version") + " " + FormatFullVersion() + "\n\n" +
                               _("Usage:") + "\n" +
                               "  lyberixv3-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded lyberixv3 transaction") + "\n" +
                               "  lyberixv3-tx [options] -create [commands]   " + _("Create hex-encoded lyberixv3 transaction") + "\n" +
                               "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded lyberixv3 transaction
