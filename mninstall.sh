...
COINDOWNLOADLINK1=https://github.com/lyberixteam/lyberix/releases/download/v1.0/lyberixd
COINDOWNLOADLINK2=https://github.com/lyberixteam/lyberix/releases/download/v1.0/lyberix-cli
COINDOWNLOADLINK3=https://github.com/lyberixteam/lyberix/releases/download/v1.0/lyberix-tx
COINPORT=40014
COINRPCPORT=40015
COINDAEMON=lyberixd
COINDAEMONCLI=lyberix-cli
COINDAEMONTX=lyberix-tx
COINCORE=.lyberix
COINCONFIG=lyberix.conf
...
echo -e "------------------------------------------------------------"
echo -e "|                                                          |"
echo -e "|        ${BOLD}---- Etter masternode installer ----${NONE}        |"
echo -e "|                                                          |"
echo -e "------------------------------------------------------------"

echo -e "${BOLD}"
read -p "This script will install a Etter masternode wallet on your VPS. Do you wish to continue? (y/n)?" response
echo -e "${NONE}"
