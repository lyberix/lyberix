...
In order to support loading of multiple wallets in lyberix-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is lyberix.cpp.
...
Changes to lyberix.cpp
----------------------
lyberix.cpp is the entry point into lyberix-qt, and as such, will require some minor modifications to provide hooks for
